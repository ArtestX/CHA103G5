			...
			<div class="row border rounded-5 p-3 bg-white shadow box-area">
				...
				<div class="row g-1 align-items-center ms-5">
					<div class="col-auto offset-1">
						<label for="text1" class="col-form-label">員工編號 : <font
...
<!-- 							</div> -->
					...
					<div class="col-auto">
						<div class="d-flex align-items-center">
							<input type="text" id="text2" class="form-control"
								name="adminAccount" value="${param.adminAccount}" size="15">
						</div>
					</div>
				</div>
				<div class="row g-1 align-items-center ms-5">
					...
					<div class="col-auto">
						<div class="d-flex align-items-center">
							<input type="password" id="password" class="form-control"
								name="adminPassword" value="${param.adminPassword}" size="15"
					...
					<div class="col-auto">
						<div class="d-flex align-items-center">
							<input type="text" id="text4" class="form-control"
								name="adminName" value="${param.adminName}" size="15"
								placeholder="請輸入姓名"> <span class="float-end  ms-2">
					...
					<div class="col-auto">
						<div class="d-flex align-items-center">
							<input type="text" id="text5" class="form-control"
								name="adminEmail" value="${param.adminEmail}" size="15"
					...
					<div class="col-auto">
						<div class="d-flex align-items-center">
							<input type="text" id="text6" class="form-control"
								name="adminPhone" value="${param.adminPhone}" size="15"
				...
				<div class="row g-1 align-items-center ms-5">
					...
					<div class="col-auto ">
						<div class="d-flex align-items-center">
							<input type="text" id="text7" class="form-control"
								name="createDate" value="${param.createDate}" size="15"
