...
<%@ page import="com.cha103g5.member.service.*"%>
<html>
<head>
<meta http-equiv="X-UA-Compatible" content="IE=edge,chrome=1"/>
<title>註冊會員 - MemberRegister.jsp</title>
...
<table id="table-1">
	<tr><td>
		 <h3>註冊會員 - MemberRegister.jsp</h3></td><td>
		 <h4><a href="select_page.jsp"><img src="img/TitleLogo.png" width="100" height="100" border="0">回首頁</a></h4>
	</td></tr>
</table>
...
<table>
	...
	<tr>
		<td>帳號:</td>
		<td><input type="TEXT" name="memberaccount" value="${param.memberaccount}" size="20"/></td> <td>${errorMsgs.memberaccount}</td>
	</tr>
	...
	<tr>
		...
		<td>
			<c:choose>
		        <c:when test="${param.memberpoints == 0}">
	...
	<tr>
		...
		<td>
			<c:choose>
		        <c:when test="${param.memberstat == 0}">
...
<% 
  ...
  try {
	   memberbirthday = java.sql.Date.valueOf(request.getParameter("memberbirthday").trim());
   } catch (Exception e) {
